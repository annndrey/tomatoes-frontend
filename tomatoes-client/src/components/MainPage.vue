	...
	<div class="col">
	  ...
	  <div class="row mt-2">
		...
		<div class="card-body" v-if="row.plantStatus">
		  ...
		  <p v-if="row.objType == 'plant' && row.plantType == 'non_tomat'" class="card-text">Plant Type: Not Tomato<br>Plant Status: {{row.plantStatus == "plants_non_health" ? "Not Healthy" : "Healthy"}}</p>
		</div>
	      </div>
	    </div>
	  </div>
